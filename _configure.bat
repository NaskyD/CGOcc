...
set PATH=%ASSIMP_HOME%;%ASSIMP_HOME%/build/code/Debug;%ASSIMP_HOME%/build/code/Release;%ASSIMP_RELEASE%;%LIBZEUG_HOME%/build/Debug;%LIBZEUG_HOME%/build/Release;%LIBZEUG_HOME%/build/Release;%GLEW%;%GLFW_HOME%;%GLEW_HOME%/bin;%QT_DIR%/bin;%GLFW_LIB_R%;%GLFW_LIB_D%;%glbinding%/Debug;%glbinding%/Release;%globjects%/Debug;%globjects%/Release;%DevIL%;%DevIL_INCLUDE%;%PATH%;